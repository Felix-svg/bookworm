        ...
        <div className="flex flex-wrap justify-center">
          <div className="w-full md:w-1/2 lg:w-1/4 p-4">
            <div className="bg-white dark:bg-gray-700 p-6 rounded shadow">
              ...
              <p>Receive tailored book suggestions based on your reading history and preferences.</p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/4 p-4">
            <div className="bg-white dark:bg-gray-700 p-6 rounded shadow">
              <h3 className="text-xl font-bold mb-2">Extensive Library</h3>
              <p>Explore our vast collection of books across various genres, from fiction and non-fiction to mystery and romance.</p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/4 p-4">
            <div className="bg-white dark:bg-gray-700 p-6 rounded shadow">
              <h3 className="text-xl font-bold mb-2">Community Reviews</h3>
              <p>Read reviews and ratings from other readers to help you decide your next read.</p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/4 p-4">
            <div className="bg-white dark:bg-gray-700 p-6 rounded shadow">
              <h3 className="text-xl font-bold mb-2">Author Insights</h3>
              <p>Get exclusive interviews and insights from your favorite authors.</p>
            </div>
          </div>
        </div>
      </div>
